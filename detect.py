...
def run(
    ...
    for path, im, im0s, vid_cap, s in dataset:
        # print(path)
        # print(torch.Tensor(im).shape)
        # print(torch.Tensor(im0s).shape)
        # print(s)
        # /Users/khanhmac/Library/CloudStorage/OneDrive-nnl06/f0_thesis/thesis/yolov5/a1_data_test/output_video.mp4
